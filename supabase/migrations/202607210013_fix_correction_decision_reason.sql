-- Resolve the PL/pgSQL ambiguity between the decision_reason input parameter
-- and attendance_correction_requests.decision_reason. The public signature and
...
begin
  ...
  if length(trim(coalesce($5,'')))<3 then
