-- Allow the catalog form's documented detail fields. Does not alter existing rows,
...
begin
 ...
 for k in select jsonb_object_keys(d) loop
  if k not in ('author','dating','materials','dimensions','provenance','owner','acquisition','custody','donor','owner_phone','owner_email','owner_address','lender','received_date','fmv','currency','loan_reference','notes','cultural_history')
